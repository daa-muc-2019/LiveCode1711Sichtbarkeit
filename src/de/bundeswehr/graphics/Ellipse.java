...
public class Ellipse {
	...
	/**
	 * The x- and y-coordinates describing the ellipse's position, denoting the top
	 * left corner of its surrounding rectangle.
	 */
	int xPos, yPos;
	...
	public void draw() {
		...
		canvas.draw(this, colour, new Ellipse2D.Double(xPos, yPos, horizontalLength, verticalLength));
		canvas.wait(0);
	}
	...
	private static class Canvas {
		...
		public static Canvas getCanvas() {
			if (canvasSingleton == null) {
				canvasSingleton = new Canvas("Shawna das Schaf", 500, 300, Color.white);
			}
